...
export type AccountIdentifierReturn = { 'Ok': AccountIdentifier } |
{ 'Err': CommonError };
export type ApiError = { 'ZeroAddress': null } |
{ 'InvalidTokenId': null } |
{ 'Unauthorized': null };
export type Balance = bigint;
export type BalanceReturn = { 'Ok': Balance } |
{ 'Err': CommonError };
...
export type MetadataContainer = { 'blob': Array<number> } |
...
{ 'Err': ApiError };
export type MetadataReturn = { 'Ok': Metadata } |
{ 'Err': CommonError };
...
{ 'Err': ApiError };
export interface MintReceiptPart { 'id': bigint, 'token_id': bigint };
...
export type TransactionRequestFilter = { 'date': [Date, Date] } |
{ 'page': [bigint, bigint] } |
{ 'txid': TransactionId } |
{ 'user': User };
...
export type TrasactionsResult = { 'Ok': Array<Transaction> } |
{ 'Err': CommonError };
...
export interface erc721_token {
    ...
    'getTransactionsDip721': (arg_0: bigint, arg_1: number) => Promise<
    ...
    'transactions': (arg_0: TransactionRequest) => Promise<TrasactionsResult>
