...
export type CandyValue__1 = { 'Int' : bigint } |
  { 'Nat' : bigint } |
  { 'Empty' : null } |
  { 'Nat16' : number } |
  { 'Nat32' : number } |
...
export type Result = { 'ok' : Properties } |
  { 'err' : Error };
export type Result_1 = { 'ok' : null } |
  { 'err' : Error };
export type Result_10 = { 'ok' : EXTAccountIdentifier } |
  { 'err' : CommonError };
export type Result_2 = { 'ok' : Metadata } |
  { 'err' : Error };
export type Result_3 = { 'ok' : Chunk } |
  { 'err' : Error };
export type Result_4 = { 'ok' : PublicToken } |
  { 'err' : Error };
export type Result_5 = { 'ok' : boolean } |
  { 'err' : string };
export type Result_6 = { 'ok' : [bigint, Array<string>] } |
  { 'err' : string };
...
export type UpdateEventCallback = { 'Set' : Callback } |
  { 'Remove' : null };
...
export default interface _SERVICE {
  ...
  'byteBufferDataZoneToBuffer' : (arg_0: AddressedChunkArray) => Promise<
      Array<Array<number>>
    >,
  ...
  'countAddressedChunksInWorkspace' : (arg_0: AddressedChunkArray) => Promise<
      bigint
    >,
  ...
  'destabalizeValueArray' : (arg_0: Array<CandyValue__1>) => Promise<
      Array<CandyValue__1>
    >,
  ...
  'fromAddressedChunks' : (arg_0: AddressedChunkArray) => Promise<
      AddressedChunkArray
    >,
  'getAddressedChunkArraySize' : (arg_0: AddressedChunkArray) => Promise<
      bigint
    >,
  'getAuthorized' : (arg_0: string) => Promise<Array<Principal>>,
  'getClassProperty' : (arg_0: CandyValue__1, arg_1: string) => Promise<
      CandyProperty
    >,
  ...
  'redeemAndClaim' : (arg_0: [] | [bigint], arg_1: boolean) => Promise<
      Result_6
    >,
  ...
  'stabalizeValueArray' : (arg_0: Array<CandyValue__1>) => Promise<
      Array<CandyValue__1>
    >,
  'stabalizeValueBuffer' : (arg_0: AddressedChunkArray) => Promise<
      Array<CandyValue__1>
    >,
  ...
  'unwrapOptionValueUnstable' : (arg_0: CandyValue__1) => Promise<
      CandyValue__1
    >,
  ...
  'valueUnstableToBytesBuffer' : (arg_0: CandyValue__1) => Promise<
      Array<number>
    >,
  'valueUnstableToFloat' : (arg_0: CandyValue__1) => Promise<number>,
  'valueUnstableToFloatsBuffer' : (arg_0: CandyValue__1) => Promise<
      Array<number>
    >,
  ...
  'workspaceDeepClone' : (arg_0: AddressedChunkArray) => Promise<
      AddressedChunkArray
    >,
  'workspaceToAddressedChunkArray' : (arg_0: AddressedChunkArray) => Promise<
      AddressedChunkArray
    >,
};